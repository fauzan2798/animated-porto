...
function HeroSection() {
  return (
    <section className=" border border-primary w-full min-h-screen relative flex justify-center items-center">
      ...
      <section className="w-full px-5 sm:px-8 md:px-12 lg:px-12 max-w-screen-lg lg:max-w-screen-xl mx-auto ">
